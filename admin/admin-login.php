...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($email)) {
    ...
    $login_err = "Please enter your 4-digit pin.";
  } else if ($pin !== '0000') {
    ...
    <div class="layout-container flex h-full grow flex-col">
      ...
      <div class="flex flex-1 justify-center py-5">
        <div class="layout-content-container flex flex-col items-center w-[576px] max-w-[576px] py-5 flex-1">
          <h2 class="text-[#111517] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 text-left pb-3 pt-5">
            Admin Login</h2>
          <?php if (!empty($login_err)): ?>
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative max-w-[480px] mx-auto mb-4">
              <?php echo $login_err; ?>
            </div>
          <?php endif; ?>
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3 mx-auto">
              <label class="flex flex-col min-w-40 flex-1">
                <p class="text-[#111517] text-base font-medium leading-normal pb-2">4-digit Pin</p>
            ...
            <div class="flex max-w-[480px] mx-auto">
              <button type="submit"
                class="flex min-w-[84px] max-w-[480px] w-full cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-5 bg-[#2c90e2] text-white text-base font-bold leading-normal tracking-[0.015em]">
