...
<html>
  <head>
    ...
    <title>Ayera - Admin Dashboard</title>
        ...
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7edf3] px-10 py-3">
          <div class="flex items-center gap-8">
            ...
            <div class="flex items-center gap-4">
              ...
              <span class="text-[#4e7397]">(Admin)</span>
            </div>
          </div>
            ...
            <div class="flex flex-col gap-6">
              <div class="flex flex-col gap-4">
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm">
                  <h2 class="text-[#0e141b] text-lg font-bold mb-4">All Reports</h2>
                  <div class="space-y-4">
                      ...
                      <?php foreach ($reports as $report): ?>
                        <div class="border-b border-[#e7edf3] pb-4">
                          <div class="flex justify-between items-start">
                            <div>
                              ...
                              <p class="text-[#4e7397] text-sm">
                                ...
                                (<?php echo ucfirst($report['user_type']); ?>)
                              </p>
                          ...
                          <div class="flex items-center gap-2 mt-2">
                            <button 
                              onclick="updateStatus(<?php echo $report['id']; ?>, 'resolved')"
                              class="text-sm text-green-600 hover:text-green-700"
                            >
                              Mark as Resolved
                            </button>
                            <button 
                              onclick="updateStatus(<?php echo $report['id']; ?>, 'pending')"
