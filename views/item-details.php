...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['claim'])) {
    ...
    try {
        ...
        // Insert claim
        $stmt = $conn->prepare("
            INSERT INTO Claims (user_id, user_type, lost_item_id, status) 
        ...
        $message = "A student has claimed your lost item: " . $item['name'];
        $notificationService->notify($item['user_id'], $item['user_type'], $message);
