      ...
      <div class="flex flex-1 justify-center py-8">
        <div class="layout-content-container flex flex-col w-full max-w-3xl px-6">
          <div class="flex justify-between items-center mb-6">
            <h1 class="text-[#0e141b] text-2xl font-bold">Notifications</h1>
          </div>
                  ...
                  <div class="p-6">
                    <div class="flex items-start gap-4">
                      <div class="flex-shrink-0">
                        <div class="w-12 h-12 rounded-full bg-[#e7edf3] flex items-center justify-center">
                          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#308ce8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <div class="flex-1">
                        <div class="flex justify-between items-start">
                          <h3 class="text-[#0e141b] font-bold">New Claim for Your Lost Item</h3>
                          <span class="text-xs text-[#4e7397]"><?php echo date('M j, Y', strtotime($notification['created_at'])); ?></span>
                        </div>
                        <p class="text-[#4e7397] mt-1">Someone has claimed your lost item: <span class="font-medium text-[#0e141b]"><?php echo htmlspecialchars($notification['item_name']); ?></span></p>
                        <div class="mt-4 flex gap-2">
                          <a href="view-claim.php?id=<?php echo $notification['claim_id']; ?>" class="bg-[#308ce8] text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-[#1a70c5]">
                            View Claim
                          </a>
                          <button class="bg-[#e7edf3] text-[#0e141b] px-4 py-2 rounded-xl text-sm font-medium hover:bg-[#d8e3ef]">
                            Mark as Read
                          </button>
                        </div>
                      </div>
