        ...
        <div class="layout-content-container flex flex-col items-center w-[600px] max-w-[600px] py-5 flex-1">
          ...
          <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3 w-full">
            <label class="flex flex-col min-w-40 flex-1">
              ...
              <input placeholder="you@ashesi.edu.gh" type="email" pattern="[a-zA-Z0-9._%+-]+@ashesi\.edu\.gh$"
                class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#0e141b] focus:outline-0 focus:ring-0 border-none bg-[#e7edf3] focus:border-none h-14 placeholder:text-[#4e7397] p-4 text-base font-normal leading-normal"
                value="" required />
          ...
          <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3 w-full">
            <label class="flex flex-col min-w-40 flex-1">
              <p class="text-[#0e141b] text-base font-medium leading-normal pb-2">Alternative Email Address</p>
          ...
          <div class="flex justify-center px-4 py-3 max-w-[480px] w-full">
            <p class="text-[#4e7397] text-sm">
              Already have an account? <a href="login.html" class="text-[#308ce8] font-medium">Sign in</a>
            </p>
          </div>
        </div>
      </div>
